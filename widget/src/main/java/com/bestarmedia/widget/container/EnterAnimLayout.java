...
import com.bestarmedia.widget.R;
import com.bestarmedia.widget.anim.Anim;
...
public class EnterAnimLayout extends FrameLayout {
    ...
    public boolean isIsAnimationRun() {
        return mIsAnimationRun;
    }

    public void setIsAnimationRun(boolean isAnimationRun) {
        this.mIsAnimationRun = isAnimationRun;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        //正在播放动画时点击才拦截
        if (ev.getAction() == MotionEvent.ACTION_DOWN && mIsAnimationRun) {
            mIsAnimationRun = false;
            return true;
        }
